...
class _DataLoaderIter(object):
    ...
    #
    #      Falsecontext, `_exit_function` is also registered as an `atexit` call.
    ...
    def __init__(self, loader):
        ...
        if self.num_workers > 0:
            ...
            _utils.signal_handling._set_worker_pids(id(self), tuple(i for i, w in enumerate(self.workers)))
